...
<head>
    ...
    {{-- Issue #327: same unpinned-Tailwind gap as login.blade.php — bare
         cdn.tailwindcss.com followed upstream latest (3.4.17 today) with no
         integrity. Pinned + hashed, #167/#221 doctrine. --}}
